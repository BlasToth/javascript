...
function guessValue() {
    if(game.btn.classList.contains("replay")) {
        ...
        game.guessInput.style.display = "block"; //vissza láthatóra none vagy block
...
function gameOver(){
    game.btn.innerHTML = "Restart Game"; //átírja a gomb szövegét
    game.guessInput.style.display = "none"; //látahtatlanná teszi
    game.btn.classList.add("replay");
    game.message.classList.add("shadow");
    game.max+= 5;
